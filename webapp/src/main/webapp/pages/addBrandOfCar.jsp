        ...
        <div class="row" align="center">
            <div class="row">
                ...
                <form action="Controller" method="post">
                    ${brand_of_car} <input type="text" maxlength="45" name="bn" id="brand_of_carForm"
                                           onKeyUp="check('brand_of_car')">
                    <p id="brand_of_car" style="color:#FF3D3D">${val_brand_of_car}</p>
                    <br>
                    ${loadingCapacity} <input type="text" maxlength="5" name="bl" id="loadingCapacityForm"
                                           onKeyUp="check('loadingCapacity')">
                    <p id="loadingCapacity" style="color:#FF3D3D">${val_loadingCapacity}</p>
                    <br>
                    ${capacity} <input type="text" maxlength="3" name="bc" id="capacityForm" onKeyUp="check('capacity')">
                    <p id="capacity" style="color:#FF3D3D">${val_capacity}</p>
                    <br>
                    ${cost_per_km} <input type="text" name="bp" id="cost_per_kmForm" onKeyUp="check('cost_per_km')">
